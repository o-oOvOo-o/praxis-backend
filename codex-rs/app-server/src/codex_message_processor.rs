...
use codex_app_server_protocol::Team;
use codex_app_server_protocol::TeamCreateParams;
use codex_app_server_protocol::TeamCreateResponse;
use codex_app_server_protocol::TeamDeleteParams;
use codex_app_server_protocol::TeamDeleteResponse;
use codex_app_server_protocol::TeamDeletedNotification;
use codex_app_server_protocol::TeamExecutionMode;
use codex_app_server_protocol::TeamMailboxMessage;
use codex_app_server_protocol::TeamMailboxParticipant;
use codex_app_server_protocol::TeamMailboxUpdatedNotification;
use codex_app_server_protocol::TeamReadParams;
use codex_app_server_protocol::TeamReadResponse;
use codex_app_server_protocol::TeamResumeMode;
use codex_app_server_protocol::TeamTask;
use codex_app_server_protocol::TeamTaskCreateParams;
use codex_app_server_protocol::TeamTaskCreateResponse;
use codex_app_server_protocol::TeamTaskListParams;
use codex_app_server_protocol::TeamTaskListResponse;
use codex_app_server_protocol::TeamTaskStatus;
use codex_app_server_protocol::TeamTaskUpdateParams;
use codex_app_server_protocol::TeamTaskUpdateResponse;
use codex_app_server_protocol::TeamTaskUpdatedNotification;
use codex_app_server_protocol::TeamTeammate;
use codex_app_server_protocol::TeamTeammateCreateParams;
use codex_app_server_protocol::TeamTeammateCreateResponse;
use codex_app_server_protocol::TeamTeammateMessageParams;
use codex_app_server_protocol::TeamTeammateMessageResponse;
use codex_app_server_protocol::TeamTeammateStatus;
use codex_app_server_protocol::TeamTeammateUpdatedNotification;
use codex_app_server_protocol::TeamUpdatedNotification;
...
impl CodexMessageProcessor {
    ...
    async fn team_create(&self, request_id: ConnectionRequestId, params: TeamCreateParams) {
        ...
        let team = match state_db_ctx
            .create_team(&codex_state::TeamCreateParams {
                id: team_id,
                lead_thread_id: params.lead_thread_id,
                name,
                objective,
                execution_mode: codex_state::TeamExecutionMode::ProcessFirst,
                resume_mode: codex_state::TeamResumeMode::Strong,
            })
            .await
        {
            Ok(team) => team,
    ...
    async fn team_teammate_create(
        ...
        if let Err(err) = state_db_ctx
            .create_team_teammate(&codex_state::TeamTeammateCreateParams {
                team_id: team_state.id.clone(),
                teammate_id: teammate_id.clone(),
                name: name.clone(),
                role: role.clone(),
                status: codex_state::TeamTeammateStatus::Pending,
                thread_id: None,
                last_error: None,
            })
            .await
            ...
            Err(err) => {
                ...
                let _ = state_db_ctx
                    .set_team_teammate_status(
                        ...
                        teammate_id.as_str(),
                        codex_state::TeamTeammateStatus::Failed,
                        None,
        ...
        if let Err(err) = state_db_ctx
            .set_team_teammate_status(
                team_state.id.as_str(),
                teammate_id.as_str(),
                codex_state::TeamTeammateStatus::Active,
    ...
    async fn sync_closed_team_teammate_for_thread(
        ...
        if let Err(err) = state_db_ctx
            .set_team_teammate_status(
                ...
                codex_state::TeamTeammateStatus::Closed,
                Some(thread_id_text.as_str()),
                None,
            )
            .await
    ...
    async fn archive_thread_common(
        ...
        let result: std::io::Result<()> = async move {
            let archive_folder = codex_home.join(codex_core::ARCHIVED_SESSIONS_SUBDIR);
...
fn api_team_from_state(team: &codex_state::Team) -> Team {
    Team {
        id: team.id.clone(),
        ...
        execution_mode: match team.execution_mode {
            codex_state::TeamExecutionMode::ProcessFirst => TeamExecutionMode::ProcessFirst,
        },
        resume_mode: match team.resume_mode {
            codex_state::TeamResumeMode::Strong => TeamResumeMode::StrongResume,
        },
...
fn api_team_teammate_from_state(teammate: &codex_state::TeamTeammate) -> TeamTeammate {
    TeamTeammate {
        ...
        status: match teammate.status {
            codex_state::TeamTeammateStatus::Pending => TeamTeammateStatus::Pending,
            codex_state::TeamTeammateStatus::Active => TeamTeammateStatus::Active,
            codex_state::TeamTeammateStatus::Failed => TeamTeammateStatus::Failed,
            codex_state::TeamTeammateStatus::Closed => TeamTeammateStatus::Closed,
        },
...
fn api_team_task_from_state(task: &codex_state::TeamTask) -> TeamTask {
    TeamTask {
        ...
        status: match task.status {
            codex_state::TeamTaskStatus::Pending => TeamTaskStatus::Pending,
            codex_state::TeamTaskStatus::InProgress => TeamTaskStatus::InProgress,
            codex_state::TeamTaskStatus::Blocked => TeamTaskStatus::Blocked,
            codex_state::TeamTaskStatus::Completed => TeamTaskStatus::Completed,
        },
...
fn api_participant_from_state(
    ...
    match kind {
        codex_state::TeamMailboxParticipantKind::Lead => TeamMailboxParticipant::Lead,
        codex_state::TeamMailboxParticipantKind::Teammate => TeamMailboxParticipant::Teammate {
...
fn state_participant_from_api(
    ...
    match participant {
        TeamMailboxParticipant::Lead => (codex_state::TeamMailboxParticipantKind::Lead, None),
        TeamMailboxParticipant::Teammate { teammate_id } => (
...
fn state_team_task_status_from_api(status: TeamTaskStatus) -> codex_state::TeamTaskStatus {
    match status {
        TeamTaskStatus::Pending => codex_state::TeamTaskStatus::Pending,
        TeamTaskStatus::InProgress => codex_state::TeamTaskStatus::InProgress,
        TeamTaskStatus::Blocked => codex_state::TeamTaskStatus::Blocked,
        TeamTaskStatus::Completed => codex_state::TeamTaskStatus::Completed,
    }
}
