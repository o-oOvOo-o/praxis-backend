...
const PAID_TOOLTIP: &str = "*New* Try the **Code Puppy App** with 2x rate limits until *April 2nd*. Run 'codep app' or visit https://chatgpt.com/codex?app-landing-page=true";
const PAID_TOOLTIP_WINDOWS: &str = "*New* Try the **Code Puppy App**, now available on **Windows**, with 2x rate limits until *April 2nd*. Run 'codep app' or visit https://chatgpt.com/codex?app-landing-page=true";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Code Puppy App**. Run 'codep app' or visit https://chatgpt.com/codex?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Code Puppy.";
const FREE_GO_TOOLTIP: &str = "*New* For a limited time, Code Puppy is included in your plan for free - let's build together.";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("codep app") {
                return false;
            }
            true
        })
...
[[announcements]]
content = "Welcome to Code Puppy! Check out the new onboarding flow."
