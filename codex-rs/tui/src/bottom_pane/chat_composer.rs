...
impl ChatComposer {
    ...
    fn stacked_status_line(&self, props: &FooterProps) -> Option<Line<'static>> {
    ...
    fn footer_props_without_stacked_status_line(props: &FooterProps) -> FooterProps {
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask Code Puppy to do anything".to_string(),
            /*disable_paste_burst*/ false,
        );
