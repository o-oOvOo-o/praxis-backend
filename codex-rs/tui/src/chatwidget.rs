...
impl ChatWidget {
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Copy => {
                ...
                match copy_result {
                    Ok(()) => {
                        self.show_info_toast("Copied latest Codex output to clipboard.");
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let header = self.model_menu_header(
            ...
            "Access legacy models by running codep -m <model_name> or in your config.toml",
        );
        self.bottom_pane.show_selection_view(SelectionViewParams {
    ...
    fn model_selection_actions(
        ...
        provider_for_action: Option<codex_core::model_provider_info::ModelProviderInfo>,
    ...
    pub(crate) fn open_plan_reasoning_scope_prompt(
        ...
        model: String,
        provider_id: String,
        provider: Option<codex_core::model_provider_info::ModelProviderInfo>,
    ...
    fn rename_confirmation_cell(name: &str, thread_id: Option<ThreadId>) -> PlainHistoryCell {
        let resume_cmd = codex_core::util::resume_command(Some(name), thread_id)
            .unwrap_or_else(|| format!("{} resume {name}", codex_core::util::PRIMARY_CLI_COMMAND));
...
const DEFAULT_COMPOSER_PLACEHOLDER: &str = "Message Code Puppy  / for commands  @ for context";
