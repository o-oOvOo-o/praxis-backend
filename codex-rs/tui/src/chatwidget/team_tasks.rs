...
impl ChatWidget {
    pub(super) fn on_team_updated_notification(
        &mut self,
        notification: codex_app_server_protocol::TeamUpdatedNotification,
    ) {
        if self
            .team_task_runtime
    ...
    pub(super) fn on_team_deleted_notification(
        &mut self,
        notification: codex_app_server_protocol::TeamDeletedNotification,
    ) {
        if self
            .team_task_runtime
    ...
    pub(super) fn on_team_teammate_updated_notification(
        &mut self,
        notification: codex_app_server_protocol::TeamTeammateUpdatedNotification,
    ) {
        if self
            .team_task_runtime
    ...
    pub(super) fn on_team_task_updated_notification(
        &mut self,
        notification: codex_app_server_protocol::TeamTaskUpdatedNotification,
    ) {
        if self
            .team_task_runtime
