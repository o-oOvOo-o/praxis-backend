...
fn test_team(team_id: &str, lead_thread_id: &str) -> codex_app_server_protocol::Team {
    codex_app_server_protocol::Team {
        id: team_id.to_string(),
        lead_thread_id: lead_thread_id.to_string(),
        name: "Test Team".to_string(),
        objective: None,
        execution_mode: codex_app_server_protocol::TeamExecutionMode::ProcessFirst,
        resume_mode: codex_app_server_protocol::TeamResumeMode::StrongResume,
        created_at: 1,
        updated_at: 1,
    }
}
...
fn test_team_task(
    ...
    status: codex_app_server_protocol::TeamTaskStatus,
    created_at: i64,
    updated_at: i64,
) -> codex_app_server_protocol::TeamTask {
    codex_app_server_protocol::TeamTask {
...
fn test_teammate(
    ...
    name: &str,
    thread_id: &str,
) -> codex_app_server_protocol::TeamTeammate {
    codex_app_server_protocol::TeamTeammate {
        team_id: team_id.to_string(),
        teammate_id: teammate_id.to_string(),
        name: name.to_string(),
        role: None,
        status: codex_app_server_protocol::TeamTeammateStatus::Active,
...
async fn context_budget_footer_stacks_above_team_task_footer() {
    ...
    chat.on_team_updated_notification(codex_app_server_protocol::TeamUpdatedNotification {
    ...
    chat.on_team_task_updated_notification(
        codex_app_server_protocol::TeamTaskUpdatedNotification {
            ...
            task: test_team_task(
                ...
                codex_app_server_protocol::TeamTaskStatus::InProgress,
                1,
                2,
            ),
        },
    ...
    chat.on_team_task_updated_notification(
        codex_app_server_protocol::TeamTaskUpdatedNotification {
            ...
            task: test_team_task(
                ...
                "Apply patch",
                None,
                codex_app_server_protocol::TeamTaskStatus::Pending,
                2,
                2,
            ),
        },
    ...
    chat.on_team_task_updated_notification(
        codex_app_server_protocol::TeamTaskUpdatedNotification {
            ...
            task: test_team_task(
                ...
                "Audit diff",
                Some("Inspect the rendered patch"),
                codex_app_server_protocol::TeamTaskStatus::Completed,
                1,
                3,
            ),
        },
...
async fn lead_thread_team_task_prefixes_assignee_in_header_and_footer() {
    ...
    chat.on_team_teammate_updated_notification(
        codex_app_server_protocol::TeamTeammateUpdatedNotification {
            team_id: "team-1".to_string(),
    ...
    chat.on_team_task_updated_notification(
        codex_app_server_protocol::TeamTaskUpdatedNotification {
            ...
            task: test_team_task(
                ...
                "Wait on approval",
                None,
                codex_app_server_protocol::TeamTaskStatus::Blocked,
                4,
                4,
            ),
        },
