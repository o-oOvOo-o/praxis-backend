    ...
    async fn handle_event(
        ...
        match event {
            ...
            AppEvent::OpenResumePicker => {
                ...
                {
                    match crate::build_codex_bridge_lookup_config(&self.config).await {
                        Ok(alternate_config) => {
                ...
                match crate::resume_picker::run_resume_picker_with_app_server(
                    ...
                    crate::SessionLookupSource::Codep,
                    picker_app_server,
            ...
            AppEvent::OpenPlanReasoningScopePrompt {
                ...
                self.chat_widget
                    .open_plan_reasoning_scope_prompt(model, provider_id, provider, effort);
            }
...
"#;
    ...
    async fn session_summary_includes_resume_hint() {
        ...
        assert_eq!(
            ...
            Some("codep resume 123e4567-e89b-12d3-a456-426614174000".to_string())
        );
    }
    ...
    async fn session_summary_prefers_name_over_id() {
        ...
        assert_eq!(
            summary.resume_command,
            Some("codep resume my-session".to_string())
        );
    }
}
