...
pub use codex_utils_home_dir::CodexHomeNamespace;
...
pub fn current_codex_home_namespace() -> CodexHomeNamespace {
    codex_utils_home_dir::current_codex_home_namespace()
}

pub fn default_codex_home_for_namespace(namespace: CodexHomeNamespace) -> std::io::Result<PathBuf> {
    codex_utils_home_dir::default_codex_home_for_namespace(namespace)
}
