...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without provider-specific awareness.
...
- Consumed by higher-level crates like `praxis-api`; it stays neutral on endpoints, headers, or API-specific error shapes.