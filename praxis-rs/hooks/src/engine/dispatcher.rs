...
use praxis_protocol::protocol::HookExecutionMode;
use praxis_protocol::protocol::HookHandlerType;
use praxis_protocol::protocol::HookRunStatus;
use praxis_protocol::protocol::HookRunSummary;
use praxis_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<praxis_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
