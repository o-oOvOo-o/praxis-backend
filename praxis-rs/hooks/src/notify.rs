...
/// Notification payload appended as the final argv argument.
...
pub fn notify_payload_json(payload: &HookPayload) -> Result<String, serde_json::Error> {
    ...
    Hook {
        ...
        func: Arc::new(move |payload: &HookPayload| {
            ...
            Box::pin(async move {
                ...
                if let Ok(notify_payload) = notify_payload_json(payload) {
...
mod tests {
    ...
    fn test_user_notification() -> Result<()> {
        let notification = UserNotification::AgentTurnComplete {
            ...
            client: Some("praxis-tui".to_string()),
    ...
    #[test]
    fn notify_payload_json_matches_wire_shape() -> Result<()> {
        ...
        let serialized = notify_payload_json(&payload)?;
        let actual: Value = serde_json::from_str(&serialized)?;
        assert_eq!(actual, expected_notification_json());
