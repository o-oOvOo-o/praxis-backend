...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [praxis_protocol::protocol::PatchApplyBeginEvent]
    /// and [praxis_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [praxis_protocol::protocol::ExecCommandBeginEvent]
    /// and [praxis_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
