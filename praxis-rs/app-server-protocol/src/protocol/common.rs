...
pub enum AuthMode {
    ...
    ApiKey,
    /// ChatGPT OAuth managed by Praxis (tokens persisted and refreshed by Praxis).
    Chatgpt,
...
client_request_definitions! {
    ...
    TeamCreate => "team/create" {
        params: v2::TeamCreateParams,
        response: v2::TeamCreateResponse,
    },
    #[experimental("team/read")]
    TeamRead => "team/read" {
        params: v2::TeamReadParams,
        response: v2::TeamReadResponse,
    },
    #[experimental("team/delete")]
    TeamDelete => "team/delete" {
        params: v2::TeamDeleteParams,
        response: v2::TeamDeleteResponse,
    },
    #[experimental("team/teammate/create")]
    TeamTeammateCreate => "team/teammate/create" {
        params: v2::TeamTeammateCreateParams,
        inspect_params: true,
        response: v2::TeamTeammateCreateResponse,
    },
    #[experimental("team/teammate/message")]
    TeamTeammateMessage => "team/teammate/message" {
        params: v2::TeamTeammateMessageParams,
        response: v2::TeamTeammateMessageResponse,
    },
    #[experimental("team/task/create")]
    TeamTaskCreate => "team/task/create" {
        params: v2::TeamTaskCreateParams,
        response: v2::TeamTaskCreateResponse,
    },
    #[experimental("team/task/list")]
    TeamTaskList => "team/task/list" {
        params: v2::TeamTaskListParams,
        response: v2::TeamTaskListResponse,
    },
    #[experimental("team/task/update")]
    TeamTaskUpdate => "team/task/update" {
        params: v2::TeamTaskUpdateParams,
        response: v2::TeamTaskUpdateResponse,
    },
...
server_notification_definitions! {
    ...
    TeamUpdated => "team/updated" (v2::TeamUpdatedNotification),
    #[experimental("team/deleted")]
    TeamDeleted => "team/deleted" (v2::TeamDeletedNotification),
    #[experimental("team/teammate/updated")]
    TeamTeammateUpdated => "team/teammate/updated" (v2::TeamTeammateUpdatedNotification),
    #[experimental("team/task/updated")]
    TeamTaskUpdated => "team/task/updated" (v2::TeamTaskUpdatedNotification),
    #[experimental("team/mailbox/updated")]
    TeamMailboxUpdated => "team/mailbox/updated" (v2::TeamMailboxUpdatedNotification),
