...
- Network approvals / sandbox settings for CLI mode: `references/praxis-network.md`
...
- `references/praxis-network.md`: fallback-only network/sandbox troubleshooting for CLI mode.
