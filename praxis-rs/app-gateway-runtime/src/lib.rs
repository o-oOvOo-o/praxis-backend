...
pub use crate::transport::AppGatewayRuntimeTransport;
...
pub async fn run_main(
    ...
    run_main_with_transport(
        ...
        AppGatewayRuntimeTransport::Stdio,
...
pub async fn run_main_with_transport(
    ...
    let otel = praxis_core::otel_init::build_provider(
        ...
        Some("praxis-app-gateway-runtime"),
        default_analytics_enabled,
    )
    .map_err(|e| {
        std::io::Error::new(
    ...
    let single_client_mode = matches!(&transport, AppGatewayRuntimeTransport::Stdio);
    ...
    match transport {
        ...
        AppGatewayRuntimeTransport::WebSocket { bind_address } => {
...
fn analytics_rpc_transport(transport: AppGatewayRuntimeTransport) -> AppGatewayRpcTransport {
    match transport {
        AppGatewayRuntimeTransport::Stdio => AppGatewayRpcTransport::Stdio,
        AppGatewayRuntimeTransport::WebSocket { .. } => AppGatewayRpcTransport::Websocket,
    }
}
