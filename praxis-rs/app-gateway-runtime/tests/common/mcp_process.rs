...
pub const DEFAULT_CLIENT_NAME: &str = "praxis-app-gateway-runtime-tests";
...
impl McpProcess {
    ...
    async fn new_with_env_and_args(
        ...
        let program = praxis_utils_cargo_bin::cargo_bin("praxis-app-gateway-runtime")
            .context("should find binary for praxis-app-gateway-runtime")?;
...
impl Drop for McpProcess {
    fn drop(&mut self) {
        // These tests spawn a `praxis-app-gateway-runtime` child process.
        //
