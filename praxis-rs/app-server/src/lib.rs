...
use praxis_app_server_protocol::TextPosition as AppTextPosition;
use praxis_app_server_protocol::TextRange as AppTextRange;
...
pub async fn run_main_with_transport(
    ...
    let log_db = praxis_state::StateRuntime::init(
