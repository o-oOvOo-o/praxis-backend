...
fn init_test_tracing() -> &'static TestTracing {
    ...
    TEST_TRACING.get_or_init(|| {
        ...
        let provider = SdkTracerProvider::builder()
            ...
            .build();
        let tracer = provider.tracer("praxis-app-server-message-processor-tests");
                ...
                ClientRequest::Initialize {
                    ...
                    params: InitializeParams {
                        client_info: ClientInfo {
                            name: "praxis-app-server-tests".to_string(),
                            title: None,
    ...
    loop {
        ...
        match envelope {
            crate::outgoing_message::OutgoingEnvelope::ToConnection {
                ...
                if matches!(
                    notification,
                    praxis_app_server_protocol::ServerNotification::ThreadStarted(_)
                ) {
                    return;
                }
            }
