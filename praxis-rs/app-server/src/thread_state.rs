...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::praxis_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: praxis_app_server_protocol::Thread,
}
...
impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<PraxisThread>) -> bool {
