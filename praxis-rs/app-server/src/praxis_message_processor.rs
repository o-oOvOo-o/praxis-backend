...
use praxis_app_server_protocol::Account;
...
use praxis_app_server_protocol::AppsListParams;
use praxis_app_server_protocol::AppsListResponse;
...
use praxis_app_server_protocol::CancelLoginAccountResponse;
use praxis_app_server_protocol::CancelLoginAccountStatus;
...
use praxis_app_server_protocol::CollaborationModeListParams;
use praxis_app_server_protocol::CollaborationModeListResponse;
use praxis_app_server_protocol::CommandExecParams;
use praxis_app_server_protocol::CommandExecResizeParams;
use praxis_app_server_protocol::CommandExecTerminateParams;
use praxis_app_server_protocol::CommandExecWriteParams;
use praxis_app_server_protocol::ConversationGitInfo;
use praxis_app_server_protocol::ConversationSummary;
use praxis_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use praxis_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
use praxis_app_server_protocol::ExperimentalFeatureListParams;
use praxis_app_server_protocol::ExperimentalFeatureListResponse;
use praxis_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use praxis_app_server_protocol::FeedbackUploadParams;
use praxis_app_server_protocol::FeedbackUploadResponse;
use praxis_app_server_protocol::FuzzyFileSearchParams;
use praxis_app_server_protocol::FuzzyFileSearchResponse;
use praxis_app_server_protocol::FuzzyFileSearchSessionStartParams;
use praxis_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use praxis_app_server_protocol::FuzzyFileSearchSessionStopParams;
use praxis_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use praxis_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use praxis_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
use praxis_app_server_protocol::GetAccountParams;
use praxis_app_server_protocol::GetAccountRateLimitsResponse;
use praxis_app_server_protocol::GetAccountResponse;
use praxis_app_server_protocol::GetAuthStatusParams;
use praxis_app_server_protocol::GetAuthStatusResponse;
use praxis_app_server_protocol::GetConversationSummaryParams;
use praxis_app_server_protocol::GetConversationSummaryResponse;
use praxis_app_server_protocol::GitDiffToRemoteResponse;
use praxis_app_server_protocol::GitInfo as ApiGitInfo;
...
use praxis_app_server_protocol::LoginApiKeyParams;
use praxis_app_server_protocol::LogoutAccountResponse;
use praxis_app_server_protocol::MarketplaceInterface;
use praxis_app_server_protocol::McpServerOauthLoginCompletedNotification;
use praxis_app_server_protocol::McpServerOauthLoginParams;
use praxis_app_server_protocol::McpServerOauthLoginResponse;
use praxis_app_server_protocol::McpServerRefreshResponse;
use praxis_app_server_protocol::McpServerStatus;
use praxis_app_server_protocol::MockExperimentalMethodParams;
use praxis_app_server_protocol::MockExperimentalMethodResponse;
use praxis_app_server_protocol::ModelListParams;
use praxis_app_server_protocol::ModelListResponse;
...
use praxis_app_server_protocol::PluginInterface;
...
use praxis_app_server_protocol::PluginSource;
...
use praxis_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
...
use praxis_app_server_protocol::SandboxMode;
use praxis_app_server_protocol::ServerNotification;
use praxis_app_server_protocol::ServerRequestResolvedNotification;
use praxis_app_server_protocol::SkillSummary;
use praxis_app_server_protocol::SkillsConfigWriteParams;
use praxis_app_server_protocol::SkillsConfigWriteResponse;
use praxis_app_server_protocol::SkillsListParams;
use praxis_app_server_protocol::SkillsListResponse;
use praxis_app_server_protocol::Team;
use praxis_app_server_protocol::TeamCreateParams;
use praxis_app_server_protocol::TeamCreateResponse;
use praxis_app_server_protocol::TeamDeleteParams;
use praxis_app_server_protocol::TeamDeleteResponse;
use praxis_app_server_protocol::TeamDeletedNotification;
use praxis_app_server_protocol::TeamExecutionMode;
use praxis_app_server_protocol::TeamMailboxMessage;
use praxis_app_server_protocol::TeamMailboxParticipant;
use praxis_app_server_protocol::TeamMailboxUpdatedNotification;
use praxis_app_server_protocol::TeamReadParams;
use praxis_app_server_protocol::TeamReadResponse;
use praxis_app_server_protocol::TeamResumeMode;
use praxis_app_server_protocol::TeamTask;
use praxis_app_server_protocol::TeamTaskCreateParams;
use praxis_app_server_protocol::TeamTaskCreateResponse;
use praxis_app_server_protocol::TeamTaskListParams;
use praxis_app_server_protocol::TeamTaskListResponse;
use praxis_app_server_protocol::TeamTaskStatus;
use praxis_app_server_protocol::TeamTaskUpdateParams;
use praxis_app_server_protocol::TeamTaskUpdateResponse;
use praxis_app_server_protocol::TeamTaskUpdatedNotification;
use praxis_app_server_protocol::TeamTeammate;
use praxis_app_server_protocol::TeamTeammateCreateParams;
use praxis_app_server_protocol::TeamTeammateCreateResponse;
use praxis_app_server_protocol::TeamTeammateMessageParams;
use praxis_app_server_protocol::TeamTeammateMessageResponse;
...
use praxis_app_server_protocol::ThreadArchiveParams;
use praxis_app_server_protocol::ThreadArchiveResponse;
use praxis_app_server_protocol::ThreadArchivedNotification;
use praxis_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use praxis_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use praxis_app_server_protocol::ThreadClosedNotification;
use praxis_app_server_protocol::ThreadCompactStartParams;
use praxis_app_server_protocol::ThreadCompactStartResponse;
use praxis_app_server_protocol::ThreadDecrementElicitationParams;
use praxis_app_server_protocol::ThreadDecrementElicitationResponse;
use praxis_app_server_protocol::ThreadForkParams;
use praxis_app_server_protocol::ThreadForkResponse;
use praxis_app_server_protocol::ThreadIncrementElicitationParams;
use praxis_app_server_protocol::ThreadIncrementElicitationResponse;
...
use praxis_app_server_protocol::ThreadLoadedListResponse;
use praxis_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use praxis_app_server_protocol::ThreadMetadataUpdateParams;
use praxis_app_server_protocol::ThreadMetadataUpdateResponse;
use praxis_app_server_protocol::ThreadNameUpdatedNotification;
use praxis_app_server_protocol::ThreadReadParams;
use praxis_app_server_protocol::ThreadReadResponse;
use praxis_app_server_protocol::ThreadRealtimeAppendAudioParams;
use praxis_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use praxis_app_server_protocol::ThreadRealtimeAppendTextParams;
use praxis_app_server_protocol::ThreadRealtimeAppendTextResponse;
use praxis_app_server_protocol::ThreadRealtimeStartParams;
use praxis_app_server_protocol::ThreadRealtimeStartResponse;
use praxis_app_server_protocol::ThreadRealtimeStopParams;
use praxis_app_server_protocol::ThreadRealtimeStopResponse;
use praxis_app_server_protocol::ThreadResumeParams;
use praxis_app_server_protocol::ThreadResumeResponse;
use praxis_app_server_protocol::ThreadRollbackParams;
use praxis_app_server_protocol::ThreadSetNameParams;
use praxis_app_server_protocol::ThreadSetNameResponse;
use praxis_app_server_protocol::ThreadShellCommandParams;
use praxis_app_server_protocol::ThreadShellCommandResponse;
...
use praxis_app_server_protocol::ThreadUnarchiveParams;
use praxis_app_server_protocol::ThreadUnarchiveResponse;
use praxis_app_server_protocol::ThreadUnarchivedNotification;
use praxis_app_server_protocol::ThreadUnsubscribeParams;
use praxis_app_server_protocol::ThreadUnsubscribeResponse;
use praxis_app_server_protocol::ThreadUnsubscribeStatus;
...
use praxis_app_server_protocol::TurnSteerParams;
use praxis_app_server_protocol::TurnSteerResponse;
use praxis_app_server_protocol::UserInput as V2UserInput;
use praxis_app_server_protocol::WindowsSandboxSetupCompletedNotification;
use praxis_app_server_protocol::WindowsSandboxSetupMode;
use praxis_app_server_protocol::WindowsSandboxSetupStartParams;
use praxis_app_server_protocol::WindowsSandboxSetupStartResponse;
use praxis_app_server_protocol::build_turns_from_rollout_items;
...
use praxis_core::plugins::load_plugin_apps;
use praxis_core::plugins::load_plugin_mcp_servers;
...
use praxis_git_utils::git_diff_to_remote;
...
/// Handles JSON-RPC messages for Praxis threads (and legacy conversation APIs).
...
impl PraxisMessageProcessor {
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = praxis_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = praxis_app_server_protocol::LoginAccountResponse::Chatgpt {
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match request_device_code(&opts).await {
                Ok(device_code) => {
                    ...
                    let response =
                        praxis_app_server_protocol::LoginAccountResponse::ChatgptDeviceCode {
                            login_id: login_id.to_string(),
                            verification_url,
                            user_code,
                        };
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<praxis_app_server_protocol::AskForApproval>,
        approvals_reviewer: Option<praxis_app_server_protocol::ApprovalsReviewer>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(praxis_app_server_protocol::AskForApproval::to_core),
            approvals_reviewer: approvals_reviewer
                .map(praxis_app_server_protocol::ApprovalsReviewer::to_core),
    ...
    async fn thread_set_name(&self, request_id: ConnectionRequestId, params: ThreadSetNameParams) {
        ...
        if let Err(err) =
            praxis_core::append_thread_name(&self.config.praxis_home, thread_id, &name).await
        {
            self.send_internal_error(request_id, format!("failed to set thread name: {err}"))
                .await;
            return;
    ...
    async fn ensure_thread_metadata_row_exists(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.praxis_home, &thread_uuid.to_string())
                .await
            {
                Ok(Some(path)) => path,
    ...
    async fn thread_list(&self, request_id: ConnectionRequestId, params: ThreadListParams) {
        ...
        let names = match find_thread_names_by_ids(&self.config.praxis_home, &thread_ids).await {
            Ok(names) => names,
            Err(err) => {
    ...
    async fn team_create(&self, request_id: ConnectionRequestId, params: TeamCreateParams) {
    ...
    async fn team_read(&self, request_id: ConnectionRequestId, params: TeamReadParams) {
        let Some(state_db_ctx) = self.require_team_state_db(&request_id).await else {
            return;
        };
        let Some(team) = self
    ...
    async fn team_delete(&self, request_id: ConnectionRequestId, params: TeamDeleteParams) {
        let Some(state_db_ctx) = self.require_team_state_db(&request_id).await else {
            return;
        };
        let Some(team) = self
    ...
    async fn team_teammate_message(
        &self,
        request_id: ConnectionRequestId,
    ...
    async fn team_task_list(&self, request_id: ConnectionRequestId, params: TeamTaskListParams) {
        let Some(state_db_ctx) = self.require_team_state_db(&request_id).await else {
            return;
        };
        let Some(team_state) = self
    ...
    async fn attach_thread_name(&self, thread_id: ThreadId, thread: &mut Thread) {
        match find_thread_name_by_id(&self.config.praxis_home, &thread_id).await {
            Ok(name) => {
                thread.name = name;
            }
            Err(err) => {
    ...
    async fn get_thread_summary(
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.praxis_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match praxis_core::find_thread_path_by_id_str(
                    &self.config.praxis_home,
        ...
        match read_summary_from_rollout(&path, fallback_provider).await {
            Ok(summary) => {
                let response = GetConversationSummaryResponse {
                    summary: hydrate_rollout_summary_with_state_db(&self.config, summary).await,
                };
                self.outgoing.send_response(request_id, response).await;
            }
            Err(err) => {
    ...
    async fn require_known_thread_reference(
        ...
        if self.thread_manager.get_thread(thread_id).await.is_ok()
            || read_summary_from_state_db_by_thread_id(&self.config, thread_id)
                .await
                .is_some()
        {
            return Some(thread_id);
        }
        match find_thread_path_by_id_str(&self.config.praxis_home, &thread_id.to_string()).await {
            Ok(Some(_)) => Some(thread_id),
            Ok(None) => {
                self.send_invalid_request_error(
                    request_id.clone(),
    ...
    async fn wait_for_thread_shutdown(thread: &Arc<PraxisThread>) -> ThreadShutdownResult {
        ...
        for cwd in cwds {
            ...
            let cwd_abs = match AbsolutePathBuf::try_from(cwd.as_path()) {
                ...
                Err(err) => {
                    ...
                    data.push(praxis_app_server_protocol::SkillsListEntry {
                        cwd,
                        skills: Vec::new(),
        ...
        let (data, marketplace_load_errors) = match tokio::task::spawn_blocking(move || {
            ...
            Ok::<
                (
                    ...
                    Vec<praxis_app_server_protocol::MarketplaceLoadErrorInfo>,
                ),
                MarketplaceError,
            >((
                outcome
                ...
                outcome
                    .errors
                    .into_iter()
                    .map(|err| praxis_app_server_protocol::MarketplaceLoadErrorInfo {
    ...
    async fn start_detached_review(
        ...
        let rollout_path = if let Some(path) = parent_thread.rollout_path() {
            ...
            find_thread_path_by_id_str(&self.config.praxis_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
...
async fn handle_pending_thread_resume_request(
    ...
    match find_thread_name_by_id(praxis_home, &conversation_id).await {
...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_review_policy) = request.approvals_reviewer.as_ref() {
        let active_review_policy: praxis_app_server_protocol::ApprovalsReviewer =
...
) -> Vec<praxis_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path_to_skills_md);
            praxis_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    praxis_app_server_protocol::SkillInterface {
                        display_name: interface.display_name,
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    praxis_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| praxis_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[praxis_core::skills::SkillError],
) -> Vec<praxis_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| praxis_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
async fn hydrate_rollout_summary_with_state_db(
    config: &Config,
    mut summary: ConversationSummary,
) -> ConversationSummary {
    if let Some(persisted) =
        read_summary_from_state_db_by_thread_id(config, summary.conversation_id).await
    {
...
fn merge_mutable_summary_metadata(
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match praxis_core::parse_turn_item(&item) {
...
fn preview_from_rollout_items(items: &[RolloutItem]) -> String {
    items
        ...
        .find_map(|item| match item {
            RolloutItem::ResponseItem(item) => match praxis_core::parse_turn_item(item) {
                Some(praxis_protocol::items::TurnItem::UserMessage(user)) => Some(user.message()),
                _ => None,
            },
            _ => None,
        })
...
mod tests {
    ...
    use anyhow::Result;
    use praxis_app_server_protocol::ServerRequestPayload;
