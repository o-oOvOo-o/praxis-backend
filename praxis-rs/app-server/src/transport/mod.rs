...
mod tests {
    ...
    async fn enqueue_incoming_request_returns_overload_error_when_queue_is_full() {
        ...
        let first_message =
            JSONRPCMessage::Notification(praxis_app_server_protocol::JSONRPCNotification {
        ...
        let request = JSONRPCMessage::Request(praxis_app_server_protocol::JSONRPCRequest {
            id: praxis_app_server_protocol::RequestId::Integer(7),
    ...
    async fn enqueue_incoming_response_waits_instead_of_dropping_when_queue_is_full() {
        ...
        let response = JSONRPCMessage::Response(praxis_app_server_protocol::JSONRPCResponse {
            id: praxis_app_server_protocol::RequestId::Integer(7),
            result: json!({"ok": true}),
        });
        ...
        match forwarded_event {
            TransportEvent::IncomingMessage {
                connection_id: queued_connection_id,
                message:
                    JSONRPCMessage::Response(praxis_app_server_protocol::JSONRPCResponse { id, result }),
            } => {
                assert_eq!(queued_connection_id, connection_id);
                assert_eq!(id, praxis_app_server_protocol::RequestId::Integer(7));
        ...
        transport_event_tx
            .send(TransportEvent::IncomingMessage {
                ...
                message: JSONRPCMessage::Notification(
                    praxis_app_server_protocol::JSONRPCNotification {
                        method: "initialized".to_string(),
                        params: None,
                    },
                ),
        ...
        route_outgoing_envelope(
            ...
            OutgoingEnvelope::ToConnection {
                ...
                message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                    ...
                    params: praxis_app_server_protocol::CommandExecutionRequestApprovalParams {
                        ...
                        additional_permissions: Some(
                            praxis_app_server_protocol::AdditionalPermissionProfile {
                                network: None,
                                file_system: Some(
                                    praxis_app_server_protocol::AdditionalFileSystemPermissions {
