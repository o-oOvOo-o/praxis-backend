    ...
    while let Some(event) = incoming_rx.recv().await {
        match event {
            JsonRpcConnectionEvent::MalformedMessage { reason } => {
                ...
                if outgoing_tx
                    .send(RpcServerOutboundMessage::Error {
                        request_id: praxis_protocol::jsonrpc_lite::RequestId::Integer(-1),
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                praxis_protocol::jsonrpc_lite::JSONRPCMessage::Request(request) => {
                ...
                praxis_protocol::jsonrpc_lite::JSONRPCMessage::Notification(notification) => {
                ...
                praxis_protocol::jsonrpc_lite::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                praxis_protocol::jsonrpc_lite::JSONRPCMessage::Error(error) => {
                    warn!(
