...
//! `EscalateRequest` over the inherited `PRAXIS_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `PRAXIS_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use praxis_protocol::approvals::EscalationPermissions;
pub use praxis_protocol::approvals::Permissions;
