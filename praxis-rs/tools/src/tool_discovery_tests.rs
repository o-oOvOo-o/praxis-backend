...
fn collect_tool_search_output_tools_groups_results_by_namespace() {
    ...
    let tools = collect_tool_search_output_tools([
        ToolSearchResultSource {
            tool_namespace: "mcp__praxis_apps__calendar",
        ...
        ToolSearchResultSource {
            tool_namespace: "mcp__praxis_apps__gmail",
    ...
    assert_eq!(
        ...
        vec![
            ToolSearchOutputTool::Namespace(ResponsesApiNamespace {
                name: "mcp__praxis_apps__calendar".to_string(),
            ...
            ToolSearchOutputTool::Namespace(ResponsesApiNamespace {
                name: "mcp__praxis_apps__gmail".to_string(),
...
#[test]
fn filter_tool_suggest_discoverable_tools_for_praxis_tui_omits_plugins() {
    ...
    assert_eq!(
        filter_tool_suggest_discoverable_tools_for_client(discoverable_tools, Some("praxis-tui"),),
