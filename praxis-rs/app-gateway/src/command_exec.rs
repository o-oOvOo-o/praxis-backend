...
use praxis_app_gateway_protocol::CommandExecOutputDeltaNotification;
use praxis_app_gateway_protocol::CommandExecOutputStream;
use praxis_app_gateway_protocol::CommandExecResizeParams;
use praxis_app_gateway_protocol::CommandExecResizeResponse;
use praxis_app_gateway_protocol::CommandExecResponse;
use praxis_app_gateway_protocol::CommandExecTerminalSize;
use praxis_app_gateway_protocol::CommandExecTerminateParams;
use praxis_app_gateway_protocol::CommandExecTerminateResponse;
use praxis_app_gateway_protocol::CommandExecWriteParams;
use praxis_app_gateway_protocol::CommandExecWriteResponse;
...
mod tests {
        ...
        let err = manager
            .start(StartCommandExecParams {
                ...
                request_id: ConnectionRequestId {
                    ...
                    request_id: praxis_app_gateway_protocol::RequestId::Integer(42),
                },
    ...
    async fn windows_sandbox_non_streaming_exec_uses_execution_path() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: praxis_app_gateway_protocol::RequestId::Integer(99),
        };
    ...
    async fn cancellation_expiration_keeps_process_alive_until_terminated() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: praxis_app_gateway_protocol::RequestId::Integer(100),
        };
        let sandbox_policy = SandboxPolicy::ReadOnly {
            access: ReadOnlyAccess::FullAccess,
            network_access: false,
    ...
    async fn windows_sandbox_process_ids_reject_terminate_requests() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: praxis_app_gateway_protocol::RequestId::Integer(2),
        };
        let process_id = ConnectionProcessId {
            connection_id: request_id.connection_id,
    ...
    async fn dropped_control_request_is_reported_as_not_running() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: praxis_app_gateway_protocol::RequestId::Integer(3),
        };
