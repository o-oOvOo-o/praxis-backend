use chrono::DateTime;
use chrono::Utc;
use praxis_core::test_support::all_model_presets;
...
pub fn write_models_cache(praxis_home: &Path) -> std::io::Result<()> {
    ...
    write_models_cache_with_models(praxis_home, models)
}
...
pub fn write_models_cache_with_models(
    ...
    let cache_path = praxis_home.join("models_cache.json");
