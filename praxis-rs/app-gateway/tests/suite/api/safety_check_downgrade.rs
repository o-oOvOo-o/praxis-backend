...
#[tokio::test]
async fn openai_model_header_mismatch_emits_model_rerouted_notification() -> Result<()> {
...
#[tokio::test]
async fn response_model_field_mismatch_emits_model_rerouted_notification_when_header_matches_requested()
-> Result<()> {
    skip_if_no_network!(Ok(()));
