...
impl FeedbackSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("praxis-feedback-{}.log", self.thread_id);
    ...
    fn feedback_attachments(
        ...
        if include_logs {
            attachments.push(Attachment {
                ...
                filename: String::from("praxis-logs.log"),
...
mod tests {
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        let extra_filename = format!("praxis-feedback-extra-{}.jsonl", ThreadId::new());
