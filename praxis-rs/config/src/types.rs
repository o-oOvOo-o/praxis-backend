//! Types used to define loaded and effective Praxis configuration values.
...
pub use praxis_protocol::config_types::AltScreenMode;
pub use praxis_protocol::config_types::ApprovalsReviewer;
pub use praxis_protocol::config_types::ModeKind;
pub use praxis_protocol::config_types::Personality;
pub use praxis_protocol::config_types::ServiceTier;
pub use praxis_protocol::config_types::WebSearchMode;
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across Praxis product surfaces in this profile.
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across Praxis product surfaces.
    pub enabled: Option<bool>,
}
...
pub struct AppConfig {
    /// When `false`, Praxis does not surface this app.
    #[serde(default = "default_enabled")]
    pub enabled: bool,
...
pub struct Tui {
    ...
    /// Use `/theme` in the TUI or see `$PRAXIS_HOME/themes` for custom themes.
    #[serde(default)]
...
pub struct Notice {
    ...
    /// Tracks whether the user has seen the OpenAI model migration prompt.
