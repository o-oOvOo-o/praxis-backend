...
**Disclaimer**: This code is pretty complex; before updating it, make
sure to deeply understand it and don't blindly trust generated changes. Feel free to update the documentation as you
modify the code
...
```rust
use praxis_utils_stream_parser::CitationStreamParser;
use praxis_utils_stream_parser::StreamTextParser;
...
```rust
use praxis_utils_stream_parser::CitationStreamParser;
use praxis_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), praxis_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use praxis_utils_stream_parser::InlineHiddenTagParser;
