//! Helpers for truncating tool and exec output using [`TruncationPolicy`](praxis_protocol::protocol::TruncationPolicy).

use praxis_protocol::models::FunctionCallOutputContentItem;
pub use praxis_utils_string::approx_bytes_for_tokens;
pub use praxis_utils_string::approx_token_count;
pub use praxis_utils_string::approx_tokens_from_byte_count;
use praxis_utils_string::truncate_middle_chars;
use praxis_utils_string::truncate_middle_with_token_budget;

pub use praxis_protocol::protocol::TruncationPolicy;
