...
//! `schemars`) so they can be embedded in Praxis's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `praxis-protocol` so other crates can convert
