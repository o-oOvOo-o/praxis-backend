...
use praxis_utils_plugins::plugin_namespace_for_skill_path;
...
fn discover_skills_under_root(root: &Path, scope: SkillScope, outcome: &mut SkillLoadOutcome) {
    ...
    // Follow symlinked directories for user, admin, and repo skills. System skills are written by Praxis itself.
