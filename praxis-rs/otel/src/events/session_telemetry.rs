...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub praxis_api_key_env_present: bool,
    pub praxis_api_key_env_enabled: bool,
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_praxis_api_key_enabled = self.metadata.auth_env.praxis_api_key_env_enabled,
