pub(crate) const OTEL_TARGET_PREFIX: &str = "praxis_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "praxis_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "praxis_otel.trace_safe";
