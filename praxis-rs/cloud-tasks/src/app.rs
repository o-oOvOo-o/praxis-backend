...
pub struct AttemptView {
    ...
    pub status: praxis_cloud_tasks_client::AttemptStatus,
...
pub enum AppEvent {
    ...
    DetailsMessagesLoaded {
        ...
        attempt_status: praxis_cloud_tasks_client::AttemptStatus,
    },
    DetailsFailed {
        id: TaskId,
        title: String,
    ...
    AttemptsLoaded {
        id: TaskId,
        attempts: Vec<praxis_cloud_tasks_client::TurnAttempt>,
    },
    /// Background completion of new task submission
    NewTaskSubmitted(Result<praxis_cloud_tasks_client::CreatedTask, String>),
    ...
    ApplyFinished {
        id: TaskId,
        result: std::result::Result<praxis_cloud_tasks_client::ApplyOutcome, String>,
    },
}
...
mod tests {
    ...
    impl praxis_cloud_tasks_client::CloudBackend for FakeBackend {
        ...
        async fn get_task_summary(
            &self,
            id: TaskId,
        ) -> praxis_cloud_tasks_client::Result<TaskSummary> {
        ...
        async fn get_task_diff(
            ...
            Err(praxis_cloud_tasks_client::CloudTaskError::Unimplemented(
                "not used in test",
            ))
        }
