...
#[derive(Parser, Debug)]
#[command(about = "Regenerate app-gateway schema fixtures")]
struct Args {
...
fn main() -> Result<()> {
    ...
    praxis_app_gateway_protocol::write_schema_fixtures_with_options(
        &schema_root,
        args.prettier.as_deref(),
        praxis_app_gateway_protocol::SchemaFixtureOptions {
