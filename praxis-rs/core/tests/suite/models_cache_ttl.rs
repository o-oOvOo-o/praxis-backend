...
const REMOTE_MODEL: &str = "praxis-test-ttl";
const VERSIONED_MODEL: &str = "praxis-test-versioned";
const MISSING_VERSION_MODEL: &str = "praxis-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "praxis-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.praxis_home.join(CACHE_FILE);
    ...
    codex
        .submit(Op::UserTurn {
            ...
            approval_policy: praxis_protocol::protocol::AskForApproval::Never,
    ...
    builder = builder
        .with_pre_build_hook(move |home| {
            let cache = ModelsCache {
                fetched_at: Utc::now(),
                etag: None,
                client_version: Some(praxis_core::models_manager::client_version_to_whole()),
