...
use praxis_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
use praxis_protocol::protocol::EventMsg;
use praxis_protocol::protocol::ExitedReviewModeEvent;
use praxis_protocol::protocol::Op;
use praxis_protocol::protocol::ReviewCodeLocation;
use praxis_protocol::protocol::ReviewFinding;
use praxis_protocol::protocol::ReviewLineRange;
...
async fn review_op_emits_lifecycle_and_review_output() {
    // Skip under Praxis sandbox network restrictions.
    skip_if_no_network!();
...
async fn review_input_isolated_from_parent_history() {
    ...
    let session_file = praxis_home.path().join("resume.jsonl");
    {
        ...
        let user = praxis_protocol::models::ResponseItem::Message {
            id: None,
            role: "user".to_string(),
        ...
        let assistant = praxis_protocol::models::ResponseItem::Message {
            id: None,
