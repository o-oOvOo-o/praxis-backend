...
use praxis_login::token_data::IdTokenInfo;
...
impl RefreshTokenTestContext {
    ...
    fn load_auth(&self) -> Result<AuthDotJson> {
        load_auth_dot_json(self.praxis_home.path(), AuthCredentialsStoreMode::File)
