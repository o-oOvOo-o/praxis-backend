...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) praxis_api_key_env_present: bool,
    pub(crate) praxis_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            praxis_api_key_env_present: self.praxis_api_key_env_present,
            praxis_api_key_env_enabled: self.praxis_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    praxis_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*praxis_api_key_env_enabled*/ false);
