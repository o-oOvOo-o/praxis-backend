...
pub(super) struct PendingUnauthorizedRetry {
    pub(in crate::client) retry_after_unauthorized: bool,
    pub(in crate::client) recovery_mode: Option<&'static str>,
    pub(in crate::client) recovery_phase: Option<&'static str>,
}
...
pub(super) struct AuthRequestTelemetryContext {
    pub(in crate::client) auth_mode: Option<&'static str>,
    pub(in crate::client) auth_header_attached: bool,
    pub(in crate::client) auth_header_name: Option<&'static str>,
    pub(in crate::client) retry_after_unauthorized: bool,
    pub(in crate::client) recovery_mode: Option<&'static str>,
    pub(in crate::client) recovery_phase: Option<&'static str>,
}
...
pub(super) async fn handle_unauthorized_unexpected_status(
