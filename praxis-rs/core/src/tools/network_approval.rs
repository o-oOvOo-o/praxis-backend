...
use praxis_network_proxy::NetworkPolicyRequest;
use praxis_network_proxy::NetworkProtocol;
...
impl NetworkApprovalService {
    ...
    async fn active_turn_context(session: &Session) -> Option<Arc<crate::praxis::TurnContext>> {
