...
use praxis_protocol::approvals::NetworkApprovalContext;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and Praxis prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub policy: &'a praxis_protocol::protocol::SandboxPolicy,
    pub file_system_policy: &'a FileSystemSandboxPolicy,
    pub network_policy: NetworkSandboxPolicy,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a Path,
    pub praxis_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(SandboxTransformRequest {
                ...
                praxis_linux_sandbox_exe: self.praxis_linux_sandbox_exe,
