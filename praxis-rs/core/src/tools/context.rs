        ...
        ResponseInputItem::Message { content, .. } => content_items_to_code_mode_result(
            &content
                ...
                .map(|item| match item {
                    ...
                    | praxis_protocol::models::ContentItem::OutputText { text } => {
                        FunctionCallOutputContentItem::InputText { text }
                    }
                    praxis_protocol::models::ContentItem::InputImage { image_url } => {
