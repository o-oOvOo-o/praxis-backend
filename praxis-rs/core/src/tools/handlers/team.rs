...
enum ResolvedParticipant {
    Lead,
    Teammate(praxis_state::TeamTeammate),
}
...
impl From<TeamTaskStatusValue> for praxis_state::TeamTaskStatus {
...
fn required_state_db(
    session: &Arc<Session>,
) -> Result<Arc<praxis_state::StateRuntime>, FunctionCallError> {
...
async fn resolve_team_context(
    session: &Arc<Session>,
    db: &Arc<praxis_state::StateRuntime>,
...
async fn require_teammate(
    ...
    teammate_id: &str,
    field_name: &str,
) -> Result<praxis_state::TeamTeammate, FunctionCallError> {
...
fn participant_ref_to_state(
    ...
    match participant {
        ParticipantRef::Lead => (praxis_state::TeamMailboxParticipantKind::Lead, None),
...
fn team_output_from_state(team: &praxis_state::Team) -> TeamOutput {
    TeamOutput {
...
fn parse_session_source_str(source: &str) -> Option<praxis_protocol::protocol::SessionSource> {
...
fn participant_output_from_state(
    ...
    match kind {
        praxis_state::TeamMailboxParticipantKind::Lead => ParticipantOutput {
            kind: ParticipantKind::Lead,
            teammate_id: None,
            name: None,
        },
        praxis_state::TeamMailboxParticipantKind::Teammate => ParticipantOutput {
            kind: ParticipantKind::Teammate,
...
fn team_teammate_output_from_state(teammate: &praxis_state::TeamTeammate) -> TeamTeammateOutput {
    TeamTeammateOutput {
        ...
        status: match teammate.status {
            praxis_state::TeamTeammateStatus::Pending => TeamTeammateStatusValue::Pending,
            praxis_state::TeamTeammateStatus::Active => TeamTeammateStatusValue::Active,
            praxis_state::TeamTeammateStatus::Failed => TeamTeammateStatusValue::Failed,
            praxis_state::TeamTeammateStatus::Closed => TeamTeammateStatusValue::Closed,
        },
...
fn team_task_output_from_state(task: &praxis_state::TeamTask) -> TeamTaskOutput {
    TeamTaskOutput {
        ...
        status: match task.status {
            praxis_state::TeamTaskStatus::Pending => TeamTaskStatusValue::Pending,
            praxis_state::TeamTaskStatus::InProgress => TeamTaskStatusValue::InProgress,
            praxis_state::TeamTaskStatus::Blocked => TeamTaskStatusValue::Blocked,
            praxis_state::TeamTaskStatus::Completed => TeamTaskStatusValue::Completed,
        },
...
fn team_message_output_from_state(message: &praxis_state::TeamMailboxMessage) -> TeamMessageOutput {
