...
use praxis_protocol::models::is_local_image_close_tag_text;
use praxis_protocol::models::is_local_image_open_tag_text;
use praxis_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use praxis_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            praxis_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
