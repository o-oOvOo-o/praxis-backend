...
use praxis_protocol::approvals::GuardianAssessmentAction;
use praxis_protocol::approvals::GuardianCommandSource;
...
fn command_assessment_action(
    ...
    GuardianAssessmentAction::Command {
        source,
        command: praxis_shell_command::parse_command::shlex_join(command),
        cwd: cwd.to_path_buf(),
    }
}
    ...
    match action {
        ...
        GuardianApprovalRequest::ApplyPatch { cwd, files, .. } => {
            GuardianAssessmentAction::ApplyPatch {
                ...
                files: files
                    .iter()
                    .map(praxis_utils_absolute_path::AbsolutePathBuf::to_path_buf)
                    .collect(),
            }
        }
        GuardianApprovalRequest::NetworkAccess {
