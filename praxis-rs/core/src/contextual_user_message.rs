use praxis_instructions::AGENTS_MD_FRAGMENT;
use praxis_instructions::ContextualUserFragmentDefinition;
use praxis_instructions::SKILL_FRAGMENT;
use praxis_protocol::items::HookPromptItem;
use praxis_protocol::items::parse_hook_prompt_fragment;
use praxis_protocol::models::ContentItem;
use praxis_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
