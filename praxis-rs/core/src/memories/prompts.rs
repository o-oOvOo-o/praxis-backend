...
use praxis_state::Phase2InputSelection;
use praxis_state::Stage1Output;
use praxis_state::Stage1OutputRef;
...
pub(crate) async fn build_memory_tool_developer_instructions(praxis_home: &Path) -> Option<String> {
    let base_path = memory_root(praxis_home);
