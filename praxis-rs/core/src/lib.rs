...
mod client_common;
mod llm;
mod non_responses_transport;
mod path_scope;
pub mod praxis;
mod prompt_profiles;
mod provider_decision_center;
...
pub use model_provider_info::ANTHROPIC_API_BASE_URL;
pub use model_provider_info::ANTHROPIC_API_KEY_ENV_VAR;
pub use model_provider_info::ANTHROPIC_API_VERSION;
pub use model_provider_info::ANTHROPIC_PROVIDER_ID;
pub use model_provider_info::DEFAULT_LMSTUDIO_PORT;
pub use model_provider_info::DEFAULT_OLLAMA_PORT;
pub use model_provider_info::FirstPartyModelOwner;
pub use model_provider_info::LMSTUDIO_OSS_PROVIDER_ID;
pub use model_provider_info::ModelProviderCompatInfo;
...
pub use model_provider_info::first_party_model_owner;
pub use model_provider_info::provider_accepts_known_first_party_model;
pub use model_provider_info::provider_accepts_registered_model_catalog;
mod event_mapping;
