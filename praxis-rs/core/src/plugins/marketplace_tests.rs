  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "praxis-curated".to_string())
                .unwrap(),
...
fn resolve_marketplace_plugin_reports_missing_plugin() {
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `praxis-curated`"
    );
}
...
fn resolve_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `praxis-curated`"
    );
}
...
fn resolve_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(resolved.plugin_id.as_key(), "default-plugin@praxis-curated");
}
...
fn resolve_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `praxis-curated`"
    );
}
