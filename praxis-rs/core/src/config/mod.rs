...
pub struct Config {
    ...
    ///
    /// - `None`: use default attribution (`Praxis <noreply@openai.com>`)
...
pub struct ConfigToml {
    ...
    /// sanctioned by Praxis will likely degrade model performance.
    ...
    /// When `false`, disables analytics across Praxis product surfaces in this machine.
    /// Defaults to `true`.
    pub analytics: Option<praxis_config::types::AnalyticsConfigToml>,

    /// When `false`, disables feedback collection across Praxis product surfaces.
    /// Defaults to `true`.
    pub feedback: Option<praxis_config::types::FeedbackConfigToml>,
    ...
    /// OTEL configuration.
    pub otel: Option<praxis_config::types::OtelConfigToml>,
    ...
    /// See [`praxis_config::types::Notice`] for more details
