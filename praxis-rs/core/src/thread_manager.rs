...
impl ThreadManager {
    ...
    pub(crate) fn with_models_provider_for_tests(
        ...
        manager._test_praxis_home_guard = Some(TempCodexHomeGuard { path: praxis_home });
        manager
    }
    ...
    async fn agent_control_for_source(&self, session_source: &SessionSource) -> AgentControl {
