...
pub(in crate::praxis::session_startup) struct ServiceManagerSet {
    ...
    pub(in crate::praxis::session_startup) models_manager: crate::capabilities::ProviderCapability,
    pub(in crate::praxis::session_startup) skills_manager: crate::capabilities::SkillsCapability,
