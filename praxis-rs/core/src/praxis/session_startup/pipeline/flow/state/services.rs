...
pub(in crate::praxis::session_startup::pipeline::flow) struct SessionStartupServices {
    ...
    pub(in crate::praxis::session_startup::pipeline::flow) models_manager:
        crate::capabilities::ProviderCapability,
    ...
    pub(in crate::praxis::session_startup::pipeline::flow) capability_runtime: CapabilityRuntime,
    pub(in crate::praxis::session_startup::pipeline::flow) skills_manager:
        crate::capabilities::SkillsCapability,
