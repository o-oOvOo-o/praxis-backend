...
pub(in crate::praxis::session_startup::pipeline) struct SessionAssemblyManagers<'a> {
    ...
    pub(in crate::praxis::session_startup::pipeline) models_manager:
        &'a crate::capabilities::ProviderCapability,
    pub(in crate::praxis::session_startup::pipeline) skills_manager:
