...
use super::super::realtime_text_for_event;

impl Session {
    pub(in crate::praxis) async fn maybe_mirror_event_text_to_realtime(&self, msg: &EventMsg) {
    ...
    pub(in crate::praxis) async fn maybe_clear_realtime_handoff_for_event(&self, msg: &EventMsg) {
