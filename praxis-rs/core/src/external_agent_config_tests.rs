...
fn service_for_paths(claude_home: PathBuf, praxis_home: PathBuf) -> ExternalAgentConfigService {
    ExternalAgentConfigService::new_for_test(praxis_home, claude_home)
}
