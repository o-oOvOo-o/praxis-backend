...
use praxis_exec_server::ExecProcess;
use praxis_exec_server::ReadResponse as ExecReadResponse;
use praxis_exec_server::StartedExecProcess;
use praxis_exec_server::WriteStatus;
use praxis_protocol::protocol::TruncationPolicy;
...
use praxis_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = praxis_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
