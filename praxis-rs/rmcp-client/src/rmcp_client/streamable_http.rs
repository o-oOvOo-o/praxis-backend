...
#[derive(Clone)]
pub(super) struct StreamableHttpResponseClient {
...
pub(super) fn build_http_client(default_headers: &HeaderMap) -> Result<reqwest::Client> {
...
pub(super) enum StreamableHttpResponseClientError {
