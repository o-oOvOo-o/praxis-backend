...
impl TestToolServer {
    ...
    /// Tool intended for manual testing of Praxis TUI rendering for MCP image tool results.
    ///
...
/// Scenarios for `image_scenario`, intended to exercise Praxis TUI handling of MCP image outputs.
///
