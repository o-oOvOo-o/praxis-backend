...
pub(crate) enum AppEvent {
    ...
    ActivateSelfworkPlan {
        plan_path: PathBuf,
    },

    /// Open the manual selfwork-plan prompt.
    OpenSelfworkPlanPrompt,

    /// Activate selfwork from user-entered text that still needs path resolution.
    StartSelfworkFromInput {
        raw_path: String,
    },
