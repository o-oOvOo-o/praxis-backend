...
//! "leave the old title alone" or "clear the title Praxis last wrote".
...
//! - bidi/invisible formatting praxisoints that can visually reorder or hide
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Praxis manages, or some other fallback.
    NoVisibleContent,
}
...
/// to single spaces, drops disallowed praxisoints, and bounds the result to
...
/// or a previous program may have set before Praxis started managing the title.
...
/// formatting praxisoints. The bidi entries here cover the Trojan-Source-style
