            ...
            vec![Event {
                ...
                msg: EventMsg::Error(ErrorEvent {
                    ...
                    praxis_error_info: notification
                        .error
                        .praxis_error_info
                        .and_then(app_server_praxis_error_info_to_core),
                }),
            }],
        )),
...
fn token_usage_from_app_server(
    value: praxis_app_server_protocol::TokenUsageBreakdown,
) -> TokenUsage {
    TokenUsage {
...
fn command_execution_completed_event(turn_id: &str, item: &ThreadItem) -> Option<Vec<Event>> {
    ...
    let status = match status {
        praxis_app_server_protocol::CommandExecutionStatus::InProgress => return Some(Vec::new()),
        praxis_app_server_protocol::CommandExecutionStatus::Completed => {
            ExecCommandStatus::Completed
        }
        praxis_app_server_protocol::CommandExecutionStatus::Failed => ExecCommandStatus::Failed,
        praxis_app_server_protocol::CommandExecutionStatus::Declined => ExecCommandStatus::Declined,
    };
...
#[cfg(test)]
fn app_server_praxis_error_info_to_core(
    value: praxis_app_server_protocol::CodexErrorInfo,
...
mod tests {
    ...
    use praxis_app_server_protocol::CodexErrorInfo;
            ...
            &Turn {
                ...
                items: vec![
                    ...
                    ThreadItem::WebSearch {
                        ...
                        action: Some(praxis_app_server_protocol::WebSearchAction::Other),
                    },
                    ThreadItem::ImageGeneration {
