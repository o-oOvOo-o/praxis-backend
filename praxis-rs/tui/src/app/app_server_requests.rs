...
mod tests {
    ...
    use praxis_app_server_protocol::PermissionGrantScope;
    use praxis_app_server_protocol::PermissionsRequestApprovalParams;
    use praxis_app_server_protocol::PermissionsRequestApprovalResponse;
    use praxis_app_server_protocol::RequestId as AppServerRequestId;
    use praxis_app_server_protocol::ServerRequest;
    use praxis_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: praxis_app_server_protocol::GrantedPermissionProfile {
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: praxis_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: praxis_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason:
                        praxis_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
