...
use praxis_core::config_loader::NetworkDomainPermissionToml;
use praxis_core::config_loader::NetworkUnixSocketPermissionToml;
    ...
    if let Some(proxy) = session_network_proxy {
        ...
        let all_proxy = session_all_proxy_url(
            ...
            config
                ...
                .network
                .as_ref()
                .is_some_and(praxis_core::config::NetworkProxySpec::socks_enabled),
        );
...
fn format_config_layer_source(source: &ConfigLayerSource) -> String {
    match source {
        ...
        ConfigLayerSource::Project { dot_praxis_folder } => {
            format!(
                "project ({}/config.toml)",
                dot_praxis_folder.as_path().display()
            )
        }
...
mod tests {
    ...
    use praxis_core::config_loader::ConstrainedWithSource;
    use praxis_core::config_loader::McpServerIdentity;
    use praxis_core::config_loader::McpServerRequirement;
    use praxis_core::config_loader::NetworkConstraints;
    use praxis_core::config_loader::NetworkDomainPermissionToml;
    use praxis_core::config_loader::NetworkDomainPermissionsToml;
    use praxis_core::config_loader::NetworkUnixSocketPermissionToml;
    use praxis_core::config_loader::NetworkUnixSocketPermissionsToml;
    use praxis_core::config_loader::RequirementSource;
    use praxis_core::config_loader::ResidencyRequirement;
    use praxis_core::config_loader::SandboxModeRequirement;
    ...
    fn debug_config_output_lists_all_layers_including_disabled() {
        ...
        let layers = vec![
            ...
            ConfigLayerEntry::new_disabled(
                ConfigLayerSource::Project {
                    dot_praxis_folder: project_folder,
                },
                empty_toml_table(),
