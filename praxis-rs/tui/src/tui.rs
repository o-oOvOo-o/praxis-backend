...
impl Tui {
    ...
    /// terminal modes (optionally keeping raw mode enabled), then re-applies Praxis TUI modes and
    ...
    pub fn draw(
        ...
        stdout().sync_update(|_| {
            ...
            if !self.pending_history_lines.is_empty() {
                ...
                crate::insert_history::insert_history_lines(terminal, pending_history_lines)?;
            }
