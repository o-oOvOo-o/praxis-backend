...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match praxis_tui::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = praxis_tui::live_wrap::RowBuilder::new(/*target_width*/ 20);
    ...
    praxis_tui::insert_history::insert_history_lines(&mut term, lines)
