...
use praxis_client::RequestCompression;
use praxis_client::RetryOn;
use praxis_client::RetryPolicy;
...
///
/// This is converted into a `RetryPolicy` used by `praxis-client` to drive
