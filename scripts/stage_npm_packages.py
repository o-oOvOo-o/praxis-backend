#!/usr/bin/env python3
"""Stage one or more Praxis npm packages for release."""
...
PRAXIS_PLATFORM_PACKAGES = getattr(_BUILD_MODULE, "PRAXIS_PLATFORM_PACKAGES", {})
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in PRAXIS_PLATFORM_PACKAGES:
