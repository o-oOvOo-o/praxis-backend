...
This document describes how exit, shutdown, and interruption work in the Rust TUI (`praxis-rs/tui`).
It is intended for Praxis developers and Praxis itself when reasoning about future exit/shutdown
changes.
...
This TUI has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
