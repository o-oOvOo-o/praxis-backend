...
class BinaryComponent:
    artifact_prefix: str  # matches the artifact filename prefix (e.g. praxis-<target>.zst)
...
BINARY_COMPONENTS = {
    ...
    "praxis-responses-api-proxy": BinaryComponent(
        ...
        dest_dir="praxis-responses-api-proxy",
        binary_basename="praxis-responses-api-proxy",
    ),
...
def main() -> int:
    ...
    with _gha_group(f"Download native artifacts from workflow {workflow_id}"):
        with tempfile.TemporaryDirectory(prefix="praxis-native-artifacts-") as artifacts_dir_str:
